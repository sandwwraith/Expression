...
public class ObjectExpressionTest extends BaseTest {
    ...
    protected Test neg(final Test a) {
        return unary(neg, a);
    }

    protected Test add(final Test a, final Test b) {
        return binary(add, a, b);
    }

    protected Test sub(final Test a, final Test b) {
        return binary(subtract, a, b);
    }

    protected Test mul(final Test a, final Test b) {
        return binary(multiply, a, b);
    }

    protected Test div(final Test a, final Test b) {
        return binary(divide, a, b);
    }
